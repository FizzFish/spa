...
extends AnalysisKey<LocalDefs> {
    ...
    public LocalDefsAnalysis(@NotNull DirectedGraph<Unit> graph, @NotNull Set<? extends Local> locals, @NotNull SimpleLocalDefs.FlowAnalysisMode mode) {
        Intrinsics.checkNotNullParameter(graph, (String)"graph");
        Intrinsics.checkNotNullParameter(locals, (String)"locals");
        Intrinsics.checkNotNullParameter((Object)mode, (String)"mode");
        super(LocalDefsAnalysisFactory.INSTANCE.getKey());
        this.graph = graph;
        this.locals = locals;
        this.mode = mode;
    }
    ...
    public LocalDefsAnalysis(@NotNull UnitGraph graph) {
        Intrinsics.checkNotNullParameter((Object)graph, (String)"graph");
        this(graph, SimpleLocalDefs.FlowAnalysisMode.Automatic);
    }

    public LocalDefsAnalysis(@NotNull UnitGraph graph, @NotNull SimpleLocalDefs.FlowAnalysisMode mode) {
        Intrinsics.checkNotNullParameter((Object)graph, (String)"graph");
        Intrinsics.checkNotNullParameter((Object)mode, (String)"mode");
    ...
    @NotNull
    public final LocalDefsAnalysis copy(@NotNull DirectedGraph<Unit> graph, @NotNull Set<? extends Local> locals, @NotNull SimpleLocalDefs.FlowAnalysisMode mode) {
        Intrinsics.checkNotNullParameter(graph, (String)"graph");
        Intrinsics.checkNotNullParameter(locals, (String)"locals");
        Intrinsics.checkNotNullParameter((Object)mode, (String)"mode");
    ...
    public static /* synthetic */ LocalDefsAnalysis copy$default(LocalDefsAnalysis localDefsAnalysis, DirectedGraph directedGraph, Set set, SimpleLocalDefs.FlowAnalysisMode flowAnalysisMode, int n, Object object) {
        if ((n & 1) != 0) {
            directedGraph = localDefsAnalysis.graph;
        }
        if ((n & 2) != 0) {
            set = localDefsAnalysis.locals;
        }
        if ((n & 4) != 0) {
            flowAnalysisMode = localDefsAnalysis.mode;
        }
        return localDefsAnalysis.copy(directedGraph, set, flowAnalysisMode);
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!(other instanceof LocalDefsAnalysis)) {
            return false;
        }
        LocalDefsAnalysis localDefsAnalysis = (LocalDefsAnalysis)other;
        if (!Intrinsics.areEqual(this.graph, localDefsAnalysis.graph)) {
            return false;
        }
        if (!Intrinsics.areEqual(this.locals, localDefsAnalysis.locals)) {
            return false;
        }
        return this.mode == localDefsAnalysis.mode;
    }
}
