...
public interface ISMethodDecl15<R, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14> 
    ...
    @NotNull
    CheckBuilder<R, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14> checkBuilder(
        @NotNull Function1<? super MethodConfig, Unit> config);

    @NotNull
    ISMethodDecl15<R, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14> model(
        @NotNull Function1<? super MethodConfig, Unit> config,
        @NotNull Function16<? super CheckBuilder<R, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14>, 
    ...
    @NotNull
    ISMethodDecl15<R, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14> modelNoArg(
        @NotNull Function1<? super MethodConfig, Unit> config,
        @NotNull Function1<? super CheckBuilder<R, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14>, Unit> block);

    interface CheckBuilder<R, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14> 
        extends ISMethodDecl.CheckBuilder<R> {

        @NotNull
        ISMethodDecl15<R, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14> getMethod();
