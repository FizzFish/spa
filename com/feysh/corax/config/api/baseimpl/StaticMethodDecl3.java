...
ISMethodDecl<R> {
    ...
    public /* synthetic */ StaticMethodDecl3(ISMethodDecl iSMethodDecl, int n, int n2, DefaultConstructorMarker defaultConstructorMarker) {
        if ((n2 & 2) != 0) {
            n = 3;
        }
        this(iSMethodDecl, n);
    ...
    @Override
    @NotNull
    public ISMethodDecl3.CheckBuilder<R, P0, P1, P2> checkBuilder(@NotNull Function1<? super MethodConfig, Unit> config) {
    ...
    @Override
    @NotNull
    public ISMethodDecl3<R, P0, P1, P2> model(@NotNull Function1<? super MethodConfig, Unit> config, @NotNull Function4<? super ISMethodDecl3.CheckBuilder<R, P0, P1, P2>, ? super IParameterT<P0>, ? super IParameterT<P1>, ? super IParameterT<P2>, Unit> block) {
        return ISMethodDecl3.DefaultImpls.model(this, config, block);
    }

    @Override
    @NotNull
    public ISMethodDecl3<R, P0, P1, P2> modelNoArg(@NotNull Function1<? super MethodConfig, Unit> config, @NotNull Function1<? super ISMethodDecl3.CheckBuilder<R, P0, P1, P2>, Unit> block) {
    ...
    public static final /* synthetic */ ISMethodDecl access$getBase$p(StaticMethodDecl3 $this) {
        return $this.base;
    }
}
