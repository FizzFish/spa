...
ISMethodDecl<R> {
    ...
    public /* synthetic */ StaticMethodDecl5(ISMethodDecl iSMethodDecl, int n, int n2, DefaultConstructorMarker defaultConstructorMarker) {
        if ((n2 & 2) != 0) {
            n = 5;
        }
        this(iSMethodDecl, n);
    ...
    @Override
    @NotNull
    public ISMethodDecl5.CheckBuilder<R, P0, P1, P2, P3, P4> checkBuilder(@NotNull Function1<? super MethodConfig, Unit> config) {
    ...
    @Override
    @NotNull
    public ISMethodDecl5<R, P0, P1, P2, P3, P4> model(@NotNull Function1<? super MethodConfig, Unit> config, @NotNull Function6<? super ISMethodDecl5.CheckBuilder<R, P0, P1, P2, P3, P4>, ? super IParameterT<P0>, ? super IParameterT<P1>, ? super IParameterT<P2>, ? super IParameterT<P3>, ? super IParameterT<P4>, Unit> block) {
        return ISMethodDecl5.DefaultImpls.model(this, config, block);
    }

    @Override
    @NotNull
    public ISMethodDecl5<R, P0, P1, P2, P3, P4> modelNoArg(@NotNull Function1<? super MethodConfig, Unit> config, @NotNull Function1<? super ISMethodDecl5.CheckBuilder<R, P0, P1, P2, P3, P4>, Unit> block) {
    ...
    public static final /* synthetic */ ISMethodDecl access$getBase$p(StaticMethodDecl5 $this) {
        return $this.base;
    }
}
