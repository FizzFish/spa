...
IIMethodDecl<R, This> {
    ...
    public /* synthetic */ InstanceMethodDecl1(IIMethodDecl iIMethodDecl, int n, int n2, DefaultConstructorMarker defaultConstructorMarker) {
        if ((n2 & 2) != 0) {
            n = 1;
        }
        this(iIMethodDecl, n);
    ...
    @Override
    @NotNull
    public IIMethodDecl1.CheckBuilder<R, This, P0> checkBuilder(@NotNull Function1<? super MethodConfig, Unit> config) {
    ...
    @Override
    @NotNull
    public IIMethodDecl1<R, This, P0> model(@NotNull Function1<? super MethodConfig, Unit> config, @NotNull Function2<? super IIMethodDecl1.CheckBuilder<R, This, P0>, ? super IParameterT<P0>, Unit> block) {
        return IIMethodDecl1.DefaultImpls.model(this, config, block);
    }

    @Override
    @NotNull
    public IIMethodDecl1<R, This, P0> modelNoArg(@NotNull Function1<? super MethodConfig, Unit> config, @NotNull Function1<? super IIMethodDecl1.CheckBuilder<R, This, P0>, Unit> block) {
    ...
    public static final /* synthetic */ IIMethodDecl access$getBase$p(InstanceMethodDecl1 $this) {
        return $this.base;
    }
}
