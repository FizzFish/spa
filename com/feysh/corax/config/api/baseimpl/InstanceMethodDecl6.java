...
IIMethodDecl<R, This> {
    ...
    public /* synthetic */ InstanceMethodDecl6(IIMethodDecl iIMethodDecl, int n, int n2, DefaultConstructorMarker defaultConstructorMarker) {
        if ((n2 & 2) != 0) {
            n = 6;
        }
        this(iIMethodDecl, n);
    ...
    @Override
    @NotNull
    public IIMethodDecl6.CheckBuilder<R, This, P0, P1, P2, P3, P4, P5> checkBuilder(@NotNull Function1<? super MethodConfig, Unit> config) {
    ...
    @Override
    @NotNull
    public IIMethodDecl6<R, This, P0, P1, P2, P3, P4, P5> model(@NotNull Function1<? super MethodConfig, Unit> config, @NotNull Function7<? super IIMethodDecl6.CheckBuilder<R, This, P0, P1, P2, P3, P4, P5>, ? super IParameterT<P0>, ? super IParameterT<P1>, ? super IParameterT<P2>, ? super IParameterT<P3>, ? super IParameterT<P4>, ? super IParameterT<P5>, Unit> block) {
        return IIMethodDecl6.DefaultImpls.model(this, config, block);
    }

    @Override
    @NotNull
    public IIMethodDecl6<R, This, P0, P1, P2, P3, P4, P5> modelNoArg(@NotNull Function1<? super MethodConfig, Unit> config, @NotNull Function1<? super IIMethodDecl6.CheckBuilder<R, This, P0, P1, P2, P3, P4, P5>, Unit> block) {
    ...
    public static final /* synthetic */ IIMethodDecl access$getBase$p(InstanceMethodDecl6 $this) {
        return $this.base;
    }
}
