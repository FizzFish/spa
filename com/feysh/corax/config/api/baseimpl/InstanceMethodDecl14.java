...
IIMethodDecl<R, This> {
    ...
    public /* synthetic */ InstanceMethodDecl14(IIMethodDecl iIMethodDecl, int n, int n2, DefaultConstructorMarker defaultConstructorMarker) {
        if ((n2 & 2) != 0) {
            n = 14;
        }
        this(iIMethodDecl, n);
    ...
    @Override
    @NotNull
    public IIMethodDecl14.CheckBuilder<R, This, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13> checkBuilder(@NotNull Function1<? super MethodConfig, Unit> config) {
    ...
    @Override
    @NotNull
    public IIMethodDecl14<R, This, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13> model(@NotNull Function1<? super MethodConfig, Unit> config, @NotNull Function15<? super IIMethodDecl14.CheckBuilder<R, This, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13>, ? super IParameterT<P0>, ? super IParameterT<P1>, ? super IParameterT<P2>, ? super IParameterT<P3>, ? super IParameterT<P4>, ? super IParameterT<P5>, ? super IParameterT<P6>, ? super IParameterT<P7>, ? super IParameterT<P8>, ? super IParameterT<P9>, ? super IParameterT<P10>, ? super IParameterT<P11>, ? super IParameterT<P12>, ? super IParameterT<P13>, Unit> block) {
        return IIMethodDecl14.DefaultImpls.model(this, config, block);
    }

    @Override
    @NotNull
    public IIMethodDecl14<R, This, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13> modelNoArg(@NotNull Function1<? super MethodConfig, Unit> config, @NotNull Function1<? super IIMethodDecl14.CheckBuilder<R, This, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13>, Unit> block) {
    ...
    public static final /* synthetic */ IIMethodDecl access$getBase$p(InstanceMethodDecl14 $this) {
        return $this.base;
    }
}
