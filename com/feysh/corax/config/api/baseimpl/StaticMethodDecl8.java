...
public final class StaticMethodDecl8<R, P0, P1, P2, P3, P4, P5, P6, P7>
        implements ISMethodDecl8<R, P0, P1, P2, P3, P4, P5, P6, P7>, ISMethodDecl<R> {
    ...
    public StaticMethodDecl8(@NotNull ISMethodDecl<R> base) {
        this(base, 8);
    }
    ...
    private static class CheckBuilderImpl<R, P0, P1, P2, P3, P4, P5, P6, P7> 
            implements ISMethodDecl8.CheckBuilder<R, P0, P1, P2, P3, P4, P5, P6, P7> {
        
        private final ISMethodDecl.CheckBuilder<R> delegate;
        private final ISMethodDecl8<R, P0, P1, P2, P3, P4, P5, P6, P7> method;

        CheckBuilderImpl(StaticMethodDecl8<R, P0, P1, P2, P3, P4, P5, P6, P7> method, 
        ...
        // Delegate all remaining methods to the underlying CheckBuilder
        @Override
