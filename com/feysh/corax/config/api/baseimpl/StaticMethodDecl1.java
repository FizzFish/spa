...
@Metadata(mv={2, 0, 0}, k=1, xi=48, d1={"\u0000f\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0000\u0018\u0000*\u0004\b\u0000\u0010\u0001*\u0004\b\u0001\u0010\u00022\u000e\u0012\u0004\u0012\u0002H\u0001\u0012\u0004\u0012\u0002H\u00020\u00032\b\u0012\u0004\u0012\u0002H\u00010\u0004B\u001f\u0012\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u00028\u00000\u0004\u0012\b\b\u0002\u0010\u0006\u001a\u00020\u0007\u00a2\u0006\u0004\b\b\u0010\tJ5\u0010\f\u001a\u000e\u0012\u0004\u0012\u00028\u0000\u0012\u0004\u0012\u00028\u00010\r2\u001f\u0010\u000e\u001a\u001b\u0012\b\u0012\u00060\u0010j\u0002`\u0011\u0012\u0004\u0012\u00020\u00120\u000fj\u0002`\u0014\u00a2\u0006\u0002\b\u0013H\u0016J2\u0010\u0015\u001a\u00020\u00122'\u0010\u0016\u001a#\u0012\u0019\u0012\u0017\u0012\u0004\u0012\u00020\u00180\u0017\u00a2\u0006\f\b\u0019\u0012\b\b\u001a\u0012\u0004\b\b(\u001b\u0012\u0004\u0012\u00020\u00120\u000fH\u0096\u0001R\u0014\u0010\u0005\u001a\b\u0012\u0004\u0012\u00028\u00000\u0004X\u0082\u0004\u00a2\u0006\u0002\n\u0000R\u0014\u0010\u0006\u001a\u00020\u0007X\u0096\u0004\u00a2\u0006\b\n\u0000\u001a\u0004\b\n\u0010\u000bR\u0016\u0010\u001c\u001a\u0004\u0018\u00010\u001d8VX\u0096\u0005\u00a2\u0006\u0006\u001a\u0004\b\u001e\u0010\u001fR\u0012\u0010 \u001a\u00020!X\u0096\u0005\u00a2\u0006\u0006\u001a\u0004\b\"\u0010#R\u0012\u0010$\u001a\u00020%X\u0096\u0005\u00a2\u0006\u0006\u001a\u0004\b&\u0010'\u00a8\u0006("}, d2={"Lcom/feysh/corax/config/api/baseimpl/StaticMethodDecl1;", "R", "P0", "Lcom/feysh/corax/config/api/ISMethodDecl1;", "Lcom/feysh/corax/config/api/ISMethodDecl;", "base", "argumentCnt", "", "<init>", "(Lcom/feysh/corax/config/api/ISMethodDecl;I)V", "getArgumentCnt", "()Ljava/lang/Integer;", "checkBuilder", "Lcom/feysh/corax/config/api/ISMethodDecl1$CheckBuilder;", "config", "Lkotlin/Function1;", "Lcom/feysh/corax/config/api/MethodConfig;", "Lcom/feysh/corax/config/api/MethodConfigType;", "", "Lkotlin/ExtensionFunctionType;", "Lcom/feysh/corax/config/api/MethodConfigBlockType;", "eachLocalVar", "block", "Lcom/feysh/corax/config/api/ISootLocalVarDecl;", "", "Lkotlin/ParameterName;", "name", "localVariable", "actualType", "Lcom/feysh/corax/config/api/utils/KFunctionType;", "getActualType", "()Lcom/feysh/corax/config/api/utils/KFunctionType;", "error", "Lcom/feysh/corax/config/api/AIAnalysisApi$Error;", "getError", "()Lcom/feysh/corax/config/api/AIAnalysisApi$Error;", "match", "Lcom/feysh/corax/config/api/IMethodMatch;", "getMatch", "()Lcom/feysh/corax/config/api/IMethodMatch;", "corax-config-api"})
public final class StaticMethodDecl1<R, P0>
implements ISMethodDecl1<R, P0>,
ISMethodDecl<R> {
    @NotNull
    ...
    public /* synthetic */ StaticMethodDecl1(ISMethodDecl iSMethodDecl, int n, int n2, DefaultConstructorMarker defaultConstructorMarker) {
        if ((n2 & 2) != 0) {
            n = 1;
        }
        this(iSMethodDecl, n);
    ...
    @Override
    @NotNull
    public ISMethodDecl1.CheckBuilder<R, P0> checkBuilder(@NotNull Function1<? super MethodConfig, Unit> config) {
    ...
    @Override
    @NotNull
    public ISMethodDecl1<R, P0> model(@NotNull Function1<? super MethodConfig, Unit> config, @NotNull Function2<? super ISMethodDecl1.CheckBuilder<R, P0>, ? super IParameterT<P0>, Unit> block) {
        return ISMethodDecl1.DefaultImpls.model(this, config, block);
    }

    @Override
    @NotNull
    public ISMethodDecl1<R, P0> modelNoArg(@NotNull Function1<? super MethodConfig, Unit> config, @NotNull Function1<? super ISMethodDecl1.CheckBuilder<R, P0>, Unit> block) {
    ...
    public static final /* synthetic */ ISMethodDecl access$getBase$p(StaticMethodDecl1 $this) {
        return $this.base;
    }
}
