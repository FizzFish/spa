...
IIMethodDecl<R, This> {
    ...
    public /* synthetic */ InstanceMethodDecl4(IIMethodDecl iIMethodDecl, int n, int n2, DefaultConstructorMarker defaultConstructorMarker) {
        if ((n2 & 2) != 0) {
            n = 4;
        }
        this(iIMethodDecl, n);
    ...
    @Override
    @NotNull
    public IIMethodDecl4.CheckBuilder<R, This, P0, P1, P2, P3> checkBuilder(@NotNull Function1<? super MethodConfig, Unit> config) {
    ...
    @Override
    @NotNull
    public IIMethodDecl4<R, This, P0, P1, P2, P3> model(@NotNull Function1<? super MethodConfig, Unit> config, @NotNull Function5<? super IIMethodDecl4.CheckBuilder<R, This, P0, P1, P2, P3>, ? super IParameterT<P0>, ? super IParameterT<P1>, ? super IParameterT<P2>, ? super IParameterT<P3>, Unit> block) {
        return IIMethodDecl4.DefaultImpls.model(this, config, block);
    }

    @Override
    @NotNull
    public IIMethodDecl4<R, This, P0, P1, P2, P3> modelNoArg(@NotNull Function1<? super MethodConfig, Unit> config, @NotNull Function1<? super IIMethodDecl4.CheckBuilder<R, This, P0, P1, P2, P3>, Unit> block) {
    ...
    public static final /* synthetic */ IIMethodDecl access$getBase$p(InstanceMethodDecl4 $this) {
        return $this.base;
    }
}
