...
public interface ISMethodDecl14<R, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13> 
    ...
    @NotNull
    CheckBuilder<R, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13> checkBuilder(
        @NotNull Function1<? super MethodConfig, Unit> config);

    @NotNull
    ISMethodDecl14<R, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13> model(
        @NotNull Function1<? super MethodConfig, Unit> config,
        @NotNull Function15<? super CheckBuilder<R, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13>, 
    ...
    @NotNull
    ISMethodDecl14<R, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13> modelNoArg(
        @NotNull Function1<? super MethodConfig, Unit> config,
        @NotNull Function1<? super CheckBuilder<R, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13>, Unit> block);

    interface CheckBuilder<R, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13> 
        extends ISMethodDecl.CheckBuilder<R> {

        @NotNull
        ISMethodDecl14<R, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13> getMethod();
