...
public interface IIMethodDecl<R, This> extends IMethodDecl<R> {
    @NotNull
    CheckBuilder<R, This> checkBuilder(@NotNull Consumer<MethodConfig> config);

    interface CheckBuilder<R, This> extends IMethodDecl.CheckBuilder<R> {
        @NotNull
        IParameterT<This> getThis();
        ...
        @NotNull
        default <T, FieldType> IAccessPathT<FieldType> field(@NotNull ILocalT<T> receiver, @Nullable Class<?> declaringClass, 
                @NotNull String fieldName, @NotNull Class<FieldType> type) {
