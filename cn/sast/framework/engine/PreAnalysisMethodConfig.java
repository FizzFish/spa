...
public final class PreAnalysisMethodConfig
extends PreAnalysisAbsConfig
implements IPreAnalysisMethodConfig {
    ...
    public /* synthetic */ PreAnalysisMethodConfig(boolean bl, boolean bl2, int n, DefaultConstructorMarker defaultConstructorMarker) {
        if ((n & 1) != 0) {
            bl = true;
        }
        if ((n & 2) != 0) {
