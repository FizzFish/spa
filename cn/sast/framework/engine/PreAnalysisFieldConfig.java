...
public final class PreAnalysisFieldConfig
extends PreAnalysisAbsConfig
implements IPreAnalysisFieldConfig {
    ...
    public /* synthetic */ PreAnalysisFieldConfig(boolean bl, boolean bl2, int n, DefaultConstructorMarker defaultConstructorMarker) {
        if ((n & 1) != 0) {
            bl = true;
        }
        if ((n & 2) != 0) {
