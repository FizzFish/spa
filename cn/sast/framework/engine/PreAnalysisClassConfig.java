...
public final class PreAnalysisClassConfig
extends PreAnalysisAbsConfig
implements IPreAnalysisClassConfig {
    ...
    public /* synthetic */ PreAnalysisClassConfig(boolean bl, boolean bl2, int n, DefaultConstructorMarker defaultConstructorMarker) {
        if ((n & 1) != 0) {
            bl = true;
        }
        if ((n & 2) != 0) {
