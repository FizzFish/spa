...
public final class HybridUnReachThenComponent
extends UnReachableEntryProvider {
    @NotNull
    private final Flow<IEntryPointProvider.AnalyzeTask> iterator;

    public HybridUnReachThenComponent(@NotNull SootCtx ctx2) {
        Intrinsics.checkNotNullParameter((Object)ctx2, (String)"ctx");
        super(ctx2, null, 2, null);
