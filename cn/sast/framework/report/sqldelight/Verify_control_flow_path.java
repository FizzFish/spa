...
public final class Verify_control_flow_path {
    ...
    public static /* synthetic */ Verify_control_flow_path copy$default(Verify_control_flow_path verify_control_flow_path, long l, long l2, int n, Object object) {
        if ((n & 1) != 0) {
            l = verify_control_flow_path.id;
        }
        if ((n & 2) != 0) {
            l2 = verify_control_flow_path.__control_flow_array_hash_id;
        }
        return verify_control_flow_path.copy(l, l2);
    }
    ...
    public int hashCode() {
        ...
        result = result * 31 + Long.hashCode(this.__control_flow_array_hash_id);
        return result;
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (this.id != verify_control_flow_path.id) {
            return false;
        }
        return this.__control_flow_array_hash_id == verify_control_flow_path.__control_flow_array_hash_id;
    }
}
