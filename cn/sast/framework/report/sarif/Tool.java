 ...
 *  cn.sast.framework.report.sarif.Tool$Companion
...
public final class Tool {
    ...
    public static /* synthetic */ Tool copy$default(Tool tool, ToolComponent toolComponent, int n, Object object) {
        if ((n & 1) != 0) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Intrinsics.areEqual((Object)this.driver, (Object)tool.driver);
    }
    ...
    public static final /* synthetic */ void write$Self$corax_framework(Tool self, CompositeEncoder output, SerialDescriptor serialDesc) {
        output.encodeSerializableElement(serialDesc, 0, (SerializationStrategy)ToolComponent.$serializer.INSTANCE, (Object)self.driver);
    }
