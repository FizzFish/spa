 ...
 *  cn.sast.framework.plugin.SootOptionsConfig$Companion
...
@Serializable
@SerialName(value="SootOptionsConfig")
...
public final class SootOptionsConfig
...
IFieldOptions {
    ...
    public int compareTo(@NotNull ConfigSerializable other) {
        ...
        if (this.getEnable() != ((SootOptionsConfig)other).getEnable()) {
    ...
    public static /* synthetic */ SootOptionsConfig copy$default(SootOptionsConfig sootOptionsConfig, String string, boolean bl, SAOptions sAOptions, int n, Object object) {
        if ((n & 1) != 0) {
            string = sootOptionsConfig.name;
        }
        if ((n & 2) != 0) {
            bl = sootOptionsConfig.enable;
        }
        if ((n & 4) != 0) {
            sAOptions = sootOptionsConfig.options;
        }
        return sootOptionsConfig.copy(string, bl, sAOptions);
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!Intrinsics.areEqual((Object)this.name, (Object)sootOptionsConfig.name)) {
            return false;
        }
        if (this.enable != sootOptionsConfig.enable) {
            return false;
        }
        return Intrinsics.areEqual((Object)this.options, (Object)sootOptionsConfig.options);
    }
