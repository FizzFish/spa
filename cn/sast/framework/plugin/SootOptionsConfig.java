...
public final class SootOptionsConfig extends ConfigSerializable implements IOptional, IFieldOptions {
    ...
    public int compareTo(@NotNull ConfigSerializable other) {
        ...
        SootOptionsConfig otherConfig = (SootOptionsConfig) other;
        if (enable != otherConfig.enable) {
            return enable ? -1 : 1;
        }
        return 0;
    }
    ...
    @NotNull
    public SootOptionsConfig copy(@NotNull String name, boolean enable, @Nullable SAOptions options) {
        if (name == null) {
            throw new IllegalArgumentException("name cannot be null");
        }
    ...
    public String toString() {
        return "SootOptionsConfig(name=" + name + ", enable=" + enable + ", options=" + options + ")";
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!(other instanceof SootOptionsConfig)) return false;

        SootOptionsConfig that = (SootOptionsConfig) other;
