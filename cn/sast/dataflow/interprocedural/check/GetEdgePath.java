...
public final class GetEdgePath
extends IPath {
    @NotNull
    ...
    private GetEdgePath(Unit node, IValue heapObject, IPath heapObjectPath, Object mt, Object key2, IValue value, IPath valuePath, Object info2) {
        super(null);
        this.node = node;
    ...
    public boolean equivTo(@Nullable Object other) {
        ...
        if (!(other instanceof GetEdgePath)) {
            return false;
        }
        if (this.equivHashCode() != ((GetEdgePath)other).equivHashCode()) {
            return false;
        }
        if (this.getNode() != ((GetEdgePath)other).getNode()) {
            return false;
        }
        if (!Intrinsics.areEqual((Object)this.heapObject, (Object)((GetEdgePath)other).heapObject)) {
            return false;
        }
        if (this.heapObjectPath != ((GetEdgePath)other).heapObjectPath) {
            return false;
        }
        if (!Intrinsics.areEqual((Object)this.mt, (Object)((GetEdgePath)other).mt)) {
            return false;
        }
        if (!Intrinsics.areEqual((Object)this.key, (Object)((GetEdgePath)other).key)) {
            return false;
        }
        if (!Intrinsics.areEqual((Object)this.value, (Object)((GetEdgePath)other).value)) {
            return false;
        }
        if (this.valuePath != ((GetEdgePath)other).valuePath) {
            return false;
        }
        return Intrinsics.areEqual((Object)this.info, (Object)((GetEdgePath)other).info);
    }
    ...
    public /* synthetic */ GetEdgePath(Unit node, IValue heapObject, IPath heapObjectPath, Object mt, Object key2, IValue value, IPath valuePath, Object info2, DefaultConstructorMarker $constructor_marker) {
