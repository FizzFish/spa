...
final class ClassPathIndexFile {
    ...
    private ClassPathIndexFile(File root, List<String> lines2) {
        this.root = root;
        this.lines = lines2.stream().map(this::extractName).collect(Collectors.toList());
    }
    ...
    private static List<String> loadLines(InputStream inputStream) throws IOException {
        ...
        return Collections.unmodifiableList(lines2);
    }
