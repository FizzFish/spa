...
implements Archive {
    ...
    extends AbstractIterator<Archive> {
        NestedArchiveIterator(Iterator<JarEntry> iterator2, Archive.EntryFilter searchFilter, Archive.EntryFilter includeFilter) {
            super(iterator2, searchFilter, includeFilter);
        }
    ...
    extends AbstractIterator<Archive.Entry> {
        EntryIterator(Iterator<JarEntry> iterator2, Archive.EntryFilter searchFilter, Archive.EntryFilter includeFilter) {
            super(iterator2, searchFilter, includeFilter);
        }
    ...
    implements Iterator<T> {
        ...
        AbstractIterator(Iterator<JarEntry> iterator2, Archive.EntryFilter searchFilter, Archive.EntryFilter includeFilter) {
